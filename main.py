...
def load():
    ...
    if _collection is None:
        ...
        _collection = load_index(COLLECTION_NAME)
        print(f"Ready. {_collection.count()} passages indexed.\n")
...
def ask(query: str, verbose: bool = False) -> str:
    ...
    # CHANGED: retrieve() now takes collection instead of (index, passages)
    docs = retrieve(query, _collection, k=TOP_K)
